...
function modalmap1(id) {
  ...
  var x2 = `<div class="modal-content">
    ...
    <button type="button" class="btn btn-secondary like"  onclick="handleLike(${id})"   style="display: ${
    localStorage.getItem("isLoggedIn") === "true" ? "block" : "none"
  }"><i class="fas fa-heart"></i></button>
    <button type="button" class="btn btn-secondary delete"  onclick="handleDelete(${id})"  data-bs-dismiss="modal"  style="display: ${
    localStorage.getItem("isLoggedIn") === "true" ? "block" : "none"
  }">delete</button>
    </div>
    </div>
...
function handleLike(id) {
  ...
  let finalArr = storedArray.map((item) =>
...
function tazetarinha() {
  ...
  switch (selectedValue) {
    case "0":
      ...
      break;
    case "1":
      finalArr = storedArray.slice().sort(function (a, b) {
        return b.stamptTime - a.stamptTime;
      });
      break;
    case "2":
    ...
    case "3":
      finalArr = storedArray.slice().sort(function (a, b) {
        return a.stamptTime - b.stamptTime;
      });
      break;
  }
  let y = [];
